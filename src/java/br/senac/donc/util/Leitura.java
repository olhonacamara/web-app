...
//               captura do periodo 
                ...
                if (linha.equals("Vereador :")) {
                    ...
                    System.out.println("Valor capturado de vereador: " + vereador.getNomeCompleto());
                }
...
//                //capturando a linha Ligação Interurbano (B.TELECOM/EMBRATEL)
                // através da contagem de linhas?:
//                if (linha.equals("Ligação Interurbano (B.TELECOM/EMBRATEL)")) {
//
//                    String interurbano = Files.readAllLines(Paths.get("/Volumes/Macintosh_HD/Users/tiagomeurer/Desktop/test.txt")).get(125);
