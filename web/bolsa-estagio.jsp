...
<div class="container">
            ...
            <div class="chart-container">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4>
                            Gastos com Bolsas e Estágios em 2017
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">
                    Ranking de gastos com Bolsas e Estágios
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <%
                            ...
                            List<Ranking> objetos = dao.listarRankingGasto("bolsa_estagio");
    ...
    <script src="resources/js/charts/chart-bolsasestagios.js"></script>