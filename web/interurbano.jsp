...
<div class="container">
            ...
            <div class="chart-container">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4>
                            Gastos com Ligações Interurbanas em 2017
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">
                    Ranking de gastos com Ligações Interurbanas
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <%
                            ...
                            List<Ranking> objetos = dao.listarRankingGasto("interurbano");
    ...
    <script src="resources/js/charts/chart-interurbano.js"></script>