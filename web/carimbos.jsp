...
<jsp:include page="resources/navbar.jsp" />
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">
                        Ranking de gastos com Carimbos
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                List<Ranking> objetos = dao.listarRankingGasto("carimbos");
        ...
        <script src="resources/js/charts/chart-carimbos.js"></script>