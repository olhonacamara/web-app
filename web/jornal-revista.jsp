...
<jsp:include page="resources/navbar.jsp" />
    ...
    <div class="container">
                ...
                <div class="chart-container">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4>
                                Gastos com Jornais e Revistas em 2017
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">
                        Ranking de gastos com Jornais e Revistas
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                List<Ranking> objetos = dao.listarRankingGasto("jornal_revista");
        ...
        <script src="resources/js/charts/chart-jornal-revista.js"></script>