...
<jsp:include page="resources/navbar.jsp" />
    ...
    <div class="container">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                List<Ranking> objetos = dao.listarRankingGasto("selos");
        ...
        <script src="resources/js/charts/chart-selos.js"></script>
