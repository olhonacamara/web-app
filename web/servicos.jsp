...
<jsp:include page="resources/navbar.jsp" />
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">
                        Ranking de gastos com Serviços
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                List<Ranking> objetos = dao.listarRankingGasto("servicos");
        ...
        <script src="resources/js/charts/chart-servicos.js"></script>